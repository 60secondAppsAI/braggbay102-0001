...
<template>
  ...
  <base-input label="AuctionEndTime" type="text" placeholder="Enter AuctionEndTime" v-model="itemToAdd.auctionEndTime"></base-input>
                  </form>
                </div>
    ...
    return {
      ...
      columns: [
		...
		dataIndex: 'auctionEndTime',
          visible: true,
          scopedSlots: { customRender: 'auctionEndTime' },
          sorter: true
          //sorter: (a, b) => a.auctionEndTime - b.auctionEndTime,
          //sorter: (a, b) => a.auctionEndTime.localeCompare(b.auctionEndTime),
        },
      ],
      pagination: {
        current: 1,
